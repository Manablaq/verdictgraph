...
const tones: Record<string, string> = {
  ...
  CHALLENGED: "border-orange-400/20 bg-orange-400/10 text-orange-200",
  SETTLED: "border-emerald-400/20 bg-emerald-400/10 text-emerald-200",
  NONE: "border-zinc-400/20 bg-zinc-400/10 text-zinc-300",
  REGISTERED: "border-sky-400/20 bg-sky-400/10 text-sky-200",
  FUNDED: "border-violet-400/20 bg-violet-400/10 text-violet-200",
  CHECKING: "border-zinc-400/20 bg-zinc-400/10 text-zinc-400",
  UNAVAILABLE: "border-rose-400/20 bg-rose-400/10 text-rose-200",
  UNKNOWN: "border-amber-400/20 bg-amber-400/10 text-amber-200",
