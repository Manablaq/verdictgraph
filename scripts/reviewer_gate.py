...
checks = {
    ...
    "Stage 4E disputed handoffs can synchronize terminal Vault recovery": "def sync_disputed_handoff_vault_status(" in REGISTRY and "handoff.vault_terminal_status=vault_status" in REGISTRY and "handoff.active=False" in REGISTRY and "function recover_active" in VAULT,
